...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa validasi berikut berisi pesan kesalahan default yang digunakan
    ...
    */
    ...
    'missing_with' => 'Kolom :attribute tidak boleh ada ketika :values hadir.',
    'missing_with_all' => 'Kolom :attribute tidak boleh ada ketika :values hadir.',
    ...
    | lebih cepat untuk menentukan pesan bahasa tertentu untuk aturan atribut tertentu.
    |
    */
    ...
    | dengan sesuatu yang lebih mudah dibaca oleh pengguna seperti "Alamat Surel"
    | daripada "email". Ini membantu membuat pesan menjadi lebih ekspresif.
    |
    */
    ...
    'attributes' => [
        ...
        'placement_id' => 'lokasi penempatan',
        'timezone' => 'zona waktu',
        'timezone_offset' => 'offset zona waktu',
        'province' => 'provinsi',
        'city' => 'kota',
    ],
